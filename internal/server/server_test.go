...
// using the nobody client to attempt to produce and consume
// the nobody client is NOT permitted to perform this actions, because the
// policy.csv doesn't desribe the nobody user's permissible actions
